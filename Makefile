...
createdb:
	docker exec -it go-rest-simple-product_database_1 createdb --username=root --owner=root products

dropdb:
	docker exec -it go-rest-simple-product_database_1 dropdb products
